...
Person person2 = new() { Name = "Person 101", Department = "Department 101" };
...
class Person
{
    ...
    public string Name
    {
        get => name.Substring(0, 3);
        set => name = value.Substring(0, 3);
    }
...
class Person
{
    ...
    public string SetName(string value) => this.name = value;
}
#endregion
...
class BackingFieldDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        optionsBuilder.UseSqlServer(
            "Server=localhost, 1433;Database=BaskingFieldDb;User ID=SA;Password=1q2w3e4r+!"
        );
    }
