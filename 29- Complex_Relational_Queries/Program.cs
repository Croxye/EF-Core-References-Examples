...
#region Query Syntax
var query =
    from photo in context.Photos
    join person in context.Persons on photo.PersonId equals person.PersonId
...
var methodQuery = context.Photos.Join(
    context.Persons,
...
var methodDatas = await query.ToListAsync();
#endregion
...
var datasSyntax = await query.ToListAsync();
#endregion

#region Method Syntax
var multipleQuery = context.Photos.Join(
    context.Persons,
...
var mDatas = await query.ToListAsync();
#endregion
#endregion
...
var query =
    from photo in context.Photos
    join person in context.Persons on photo.PersonId equals person.PersonId
    join order in context.Orders on person.PersonId equals order.PersonId
    select new
    {
        person.Name,
        photo.Url,
...
var query =
    ...
    join order in context.Orders on person.PersonId equals order.PersonId into personOrders
    select new
    {
        person.Name,
...
var query =
    ...
    join person in context.Persons on order.PersonId equals person.PersonId into orderPersons
...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Photo>().HasKey(p => p.PersonId);
