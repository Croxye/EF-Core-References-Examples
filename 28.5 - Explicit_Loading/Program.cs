...
{
    var orderss = await context.Orders.Where(o => o.EmployeeId == employee.Id).ToListAsync();
}
...
var employee3 = await context.Employees.FirstOrDefaultAsync(e => e.Id == 2);
...
var employee4 = await context.Employees.FirstOrDefaultAsync(e => e.Id == 2);
...
var employee5 = await context.Employees.FirstOrDefaultAsync(e => e.Id == 2);

var orders = await context
    .Entry(employee)
    .Collection(e => e.Orders)
    .Query()
    .Where(q => q.OrderDate.Day == DateTime.Now.Day)
    .ToListAsync();
#endregion
#endregion
