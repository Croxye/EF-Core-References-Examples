...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        #endregion
        #region Ignore
        // modelBuilder.Entity<Person>().Ignore(p => p.Laylaylom);
        #endregion
        #region Primary Key
        ...
        #endregion
        #region MaxLength
        modelBuilder.Entity<Person>().Property(p => p.Surname).HasMaxLength(13);
        #endregion
        #region Precision
        ...
        modelBuilder.Entity<Person>().Property(p => p.Surname).IsConcurrencyToken();
        #endregion
        #region CompositeKey
        ...
        #endregion
        #region HasData
        modelBuilder.Entity<Department>().HasData(new Department() { Name = "asd", Id = 1 });
        modelBuilder
            .Entity<Person>()
            .HasData(
                new Person
        ...
        #endregion
        #region HasIndex
        modelBuilder.Entity<Person>().HasIndex(p => new { p.Name, p.Surname });
        #endregion
        #region HasQueryFilter
